...
Create a new project and enable the Google+ API (or equivalent for OAuth2).

Create OAuth 2.0 credentials (Client ID and Client Secret).

Add the credentials to your configuration file (Web.config or appsettings.json):
<appSettings>
...
Open the solution (BookStore.sln) in Visual Studio 2022.
Ensure the bookStore database is running and accessible.
Press F5 or click Start in Visual Studio to run the application.
The application should launch in your default browser (e.g., http://localhost:port).
